...
<!--    <form action="admin/voide_house/imgupload" method="post" class="form-inline" enctype="multipart/form-data"> -->
...
<!--   <div class="form-group">
  ...
  <button type="submit" class="btn btn-info">增加视频</button>
             ...
             <%--         <c:forEach items="${pics}" var="pic">
				    	...
				    	<tr><th>ID</th><th>视频</th><th>描述</th><th>排序<th>管理</th></tr>
				    	
				    
				    	<c:forEach items="${pics}" var="pic" varStatus="vs">
				    	<form action="admin/voide_house" method="post">
				    	...
				    	<input type="hidden" name="house_id" value="${house.id}"/>
					    	...
					    	<td>${vs.count}</td>
					    	<td>
					    	<textarea rows="3" cols="30" name="code">${pic.code}</textarea>
					    	<%--  <input type="text" name="code" value="${pic.code}" style="width:400px;"/><br/> --%>
					    	  <%--  <c:out value="${pic.code}" escapeXml="true"></c:out> --%>
                                <%--  <iframe height=120 width=320 src='${pic.code}' frameborder=0 'allowfullscreen'></iframe>  --%>
                            </td>
					    	
                                <td>
                               
                                <input type="text" name="dis" value="${pic.dis}" style="width:400px;"/></td> 
    	...
    	%>
    		...
    		%>
					    		...
					    		<button type="submit" class="btn btn-info btn-sm"><i class="fa fa-edit">修改</i></button>
					    			...
					    			<a href="admin/voide_house?action=delimg&id=${pic.id}&hid=${house.id}" class="btn btn-danger btn-sm">
